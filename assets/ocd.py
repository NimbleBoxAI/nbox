...
with console.status("", spinner = "moon") as status:
  for _ in range(2):
    status.update(f"[[deep_sky_blue1]{str(timedelta(seconds=int(time() - st)))[2:]}[/deep_sky_blue1]] [bold dark_cyan]Getting access tokens ...[/bold dark_cyan]")
    sleep(1)
...
with console.status("", spinner = "moon") as status:
  for _ in range(3):
    status.update(f"[[deep_sky_blue1]{str(timedelta(seconds=int(time() - st)))[2:]}[/deep_sky_blue1]] [bold dark_cyan]Converting torch model to ONNX ...[/bold dark_cyan]")
    sleep(1)
...
with console.status("", spinner = "moon") as status:
  for _ in range(2):
    status.update(f"[[deep_sky_blue1]{str(timedelta(seconds=int(time() - st)))[2:]}[/deep_sky_blue1]] [bold dark_cyan]Getting one-time-url ...[/bold dark_cyan]")
    sleep(1)
...
with console.status("", spinner = "moon") as status:
  for _ in range(3):
    status.update(f"[[deep_sky_blue1]{str(timedelta(seconds=int(time() - st)))[2:]}[/deep_sky_blue1]] [bold dark_cyan]Uploading file to s3 ...[/bold dark_cyan]")
    sleep(1)
...
with console.status("", spinner = "moon") as status:
  for _ in range(2):
    status.update(f"[[deep_sky_blue1]{str(timedelta(seconds=int(time() - st)))[2:]}[/deep_sky_blue1]] [bold dark_cyan]Updating Web-Server about the status of the upload[/bold dark_cyan]")
    sleep(1)
