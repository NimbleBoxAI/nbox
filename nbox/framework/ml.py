...
#
# Time of generation (UTC): 2022-03-15T08:41:54.172064
# -----------------------------------------------------------------------------------
...
class TorchToOnnx:
  ...
  def __init__(
    ...
    **kwargs
    ...
    self._retain_param_name=_retain_param_name
...
class Framework_torch:
  ...
  def torch_to_torchscript(user_options: TorchToTorchscript, nbox_options: NboxOptions) -> Union[ModelSpec, Any]:
    ...
    spec=ModelSpec(
      ...
      exported_time=Timestamp(seconds=int(datetime.utcnow().timestamp()), nanos=0),
      inputs=[],
      outputs=[],
    )
