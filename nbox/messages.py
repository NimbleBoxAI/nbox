...
Contains methods defined [here](https://github.com/googleapis/python-api-core/blob/main/google/api_core/protobuf_helpers.py)
"""

# Copyright 2017 Google LLC
# Copyright 2022 NimbleBox.ai
#
...
def read_file_to_string(file, message: message.Message):
  from google.protobuf.text_format import Parse
  with open(file, "r") as f:
    Parse(f.read(), message)
  return message

def write_binary_to_file(message: message.Message, file):
  with open(file, "wb") as f:
    f.write(message.SerializeToString())

def read_file_to_binary(file, message: message.Message):
...
The functions defined below are from 
"""
################################################################################
